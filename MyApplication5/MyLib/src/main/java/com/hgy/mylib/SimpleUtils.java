...
public  class SimpleUtils {
    ...
    public static boolean saveBitmapToSdCard(Context context, Bitmap mybitmap, String name){
        ...
        //创建位图保存目录
        String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath() + "/Hmm";
    ...
    public static String getSaveBitmapToSdCard(Context context, Bitmap mybitmap, String name){
     ...
     * @return
     */
    public static Bitmap getCacheBitmAapFromView(View view) {
...
//            scrollView.getChildAt(i).setBackground(scrollView.getChildAt(i).getBackground());
        }
        if (h>0) {
